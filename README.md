...
(Source code not availiable for version 1.2.2 (because I am lazy and it is basically the same thing as 1.2))

## How to play
1. Download and Install the Python coding language at https://www.python.org/. (Optional)
2. Download the [mastermind installer v1.2.2.exe](https://github.com/4vstin/mastermind/raw/main/mastermind%20installer%20v1.2.2.exe) file.
